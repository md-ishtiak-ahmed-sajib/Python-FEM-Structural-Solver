...
| F-013 | Public GitHub repository and release | Complete | [v0.2.0 release](https://github.com/md-ishtiak-ahmed-sajib/Python-FEM-Structural-Solver/releases/tag/v0.2.0), reviewed attribution, checksums and security reporting |
